...
// Font stacks — serif for Latin headings, sans for body, mono for labels,
// khmer for actual Khmer-script content.
export const fonts = {
  // Latin serif for English headings (collection name, curator, etc).
  // Georgia/Noto Serif/Times New Roman have no Khmer glyphs, so this stack
  // must never be used for real Khmer text — use `khmer` below instead.
  serif: 'Georgia, "Noto Serif", "Times New Roman", serif',
  sans: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
  mono: "'Courier New', monospace",
  // Loaded via Google Fonts <link> in app/layout.js. Falls back to the
  // browser's default Khmer system font if the stylesheet hasn't loaded yet.
